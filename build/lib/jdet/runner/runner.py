...
class Runner:
    def __init__(self):
        ...
        self.vis_data = LoadImages("/data2/zhangyong/workspace/project/yolox/dataset/images/test/", img_size=640)
    ...
    def run_on_images(self,save_dir=None,**kwargs):
        ...
        # 选择颜色和线宽，可以根据标签或者其他条件动态调整
            ...
            save__name = os.path.join("/data2/zhangyong/workspace/project/yolox/JDet-master/projects/yolo/output",path.split("/")[-1])
            if a > 0:
